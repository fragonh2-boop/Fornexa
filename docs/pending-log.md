...
- **Estado:** DIAGNOSTICADO; DRIFT DDL SOURCE-ONLY REPARADO EN `main`; PRODUCCIÓN SANA; COMPARACIONES Y REPLAY CONTROLADO PENDIENTES
...
- **Siguiente paso ejecutable:** contrastar los seis pares reabiertos y `fornexa_operational_core`; después preparar la reconciliación no productiva con el hardening recuperado y ambos Git-only. El replay posterior sigue cost-gated.
