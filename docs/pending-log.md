...
- **Siguiente paso ejecutable:** comparar contenido SQL exacto de los 29 pares con drift y preparar una rama de reconciliación no productiva que preserve el hardening recuperado y clasifique explícitamente los dos Git-only.
...
- **Criterio de cierre:** replay limpio + mapa de equivalencia por contenido + alineación de historial revisada + Git integration deja `MIGRATIONS_FAILED` sin alterar invariantes productivos.
