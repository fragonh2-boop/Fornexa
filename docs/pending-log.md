...
- **Corrección preparada:** el borrador nace vacío y al 0%; UI y `POST /api/cmr` comparten una única regla de completitud, con origen Expedición/Viaje, campos legales, Customer ID y régimen ADR condicional. Los valores compuestos solo por espacios no cuentan como completos.
