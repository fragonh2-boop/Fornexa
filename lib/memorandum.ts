...
export const memorandumPending: MemorandumPending[] = [
  ...
  },
  {
    ...
    summary: "PR #66 ya está en producción: las mercancías 6-12 usan tabla semántica con thead repetible y cada hoja que contiene mercancía repite la identidad CMR y los encabezados de columnas. El refinamiento visual del marco físico por página está preparado para revisión: usa el borde nativo A4 sin modificar la geometría ni la paginación validadas. Aún no está integrado ni desplegado; sigue pendiente la revisión y la comprobación operativa con un CMR real.",
    priority: "Siguiente",
    state: "En seguimiento",
  },
  {
